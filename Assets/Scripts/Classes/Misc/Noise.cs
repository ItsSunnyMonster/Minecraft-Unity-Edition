...
public static class Noise
{
    ...
    /// <summary>
    /// Generates and returns 2D Noise Map
    /// </summary>
    ...
    public static float Get2DNoiseValue(Vector2 point, float noiseSizeMultiplier, float noiseAmplifier)
    {
        ...
        var value = Mathf.PerlinNoise(point.x * noiseSizeMultiplier, point.y * noiseSizeMultiplier);
    ...
    {
        // Get the noise value plus all the modification
        var value = PerlinNoise3D(point * noiseSizeMultiplier);
